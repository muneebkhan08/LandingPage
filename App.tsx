        ...
        <div className="max-w-2xl w-full relative z-10 flex flex-col items-center gap-12 animate-in fade-in zoom-in-95 duration-700">
            ...
            <div className="flex flex-col items-center text-center gap-6">
                ...
                <div className="space-y-2">
                    <h1 className="text-4xl font-extrabold text-white tracking-tight">EduAI</h1>
                    <p className="text-slate-400 font-light text-sm max-w-[280px] mx-auto leading-relaxed">
                        Making learning easier, faster and fun for every learner
                    </p>
                </div>
            </div>
            ...
            <footer className="mt-12 text-center space-y-2">
                 <p className="text-slate-600 text-xs font-mono">© 2025 EduAI Systems</p>
            </footer>
